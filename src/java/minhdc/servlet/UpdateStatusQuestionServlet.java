...
public class UpdateStatusQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.updateStatusAndSubjectQuestion(questionID,subjectID)) {
                url = actionLoad
                        + "?pageIndex=" + pageIndex
            ...
            log("UpdateStatusQuestionServlet_NamingEx: " + ex.getMessage());
        } catch (SQLException ex) {
            log("UpdateStatusQuestionServlet_SQLExceptionEx: " + ex.getMessage());
        } finally {
